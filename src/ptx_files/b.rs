...
)
{
	...
	cvt.s64.s32 	%rd10, %r1;
	add.s64 	%rd42, %rd10, 1;
	setp.gt.u64 	%p2, %rd42, 999999999999;
	@%p2 bra 	$L__BB1_11;
...
$L__BB1_9:
	...
	setp.lt.u64 	%p9, %rd42, 1000000000000;
	@%p9 bra 	$L__BB1_3;
	bra.uni 	$L__BB1_11;
$L__BB1_3:
	{ // callseq 0, 0
